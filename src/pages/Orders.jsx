          ...
          <div className="w-full flex flex-wrap sm:flex-col justify-center items-start gap-5 text-sm text-gray-600">
            {
              allOrders.map((order, index) => (
                <div key={index} className="border-2 border-gray-400 w-full flex flex-col sm:flex-row justify-center sm:justify-between items-start gap-2.5 sm:gap-0 p-3 md:p-6">
